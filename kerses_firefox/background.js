...
function sendCSResponse(data) {
  ...
  browser.tabs.query({active: true, currentWindow: true}, function(tabs) {
    browser.tabs.sendMessage(tabs[0].id, data, function(response) {
...
// Start building the box and the process of cleaning
// the url and sending the url to the server for info
...
// Start the building of the box and begin to clean the
// url so it can be looked up. Same as build_box except
// it sends the current page url that the user asks for
